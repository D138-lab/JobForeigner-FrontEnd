...
const EditResumePage = lazy(() => import('./pages/profile/resume/edit/Page'));
...
const EditCommunityPostPage = lazy(
  () => import('./pages/community/EditPostPage'),
);
...
const SuspensedEditResumePage = withSuspense(EditResumePage);
...
const SuspensedEditCommunityPostPage = withSuspense(EditCommunityPostPage);
  ...
  createRoutesFromElements(
    <>
      ...
      <Route path={PATH.INDEX} element={<Layout />}>
        ...
        />
        <Route
          path={PATH.EDIT_COMMUNITY_POST}
          element={<SuspensedEditCommunityPostPage />}
        />
        <Route
      ...
      >
        ...
        />
        <Route
          path={PATH.PROFILE_RESUME_EDIT}
          element={<SuspensedEditResumePage />}
        />
        <Route
