...
export const postDetailDummyData = [
  {
    id: 1,
    imageUrl: 'https://randomuser.me/api/portraits/men/32.jpg',
    name: '응우옌 반 민',
    ...
    title: 'E-9 취업비자 갱신 방법이 궁금합니다',
    content:
      '현재 E-9 비자로 근무 중인데 몇 달 후 만료 예정입니다. 갱신 시 필요한 서류와 절차, 소요 기간을 알고 싶습니다. 회사에서 별도로 준비해줘야 하는 서류가 있는지도 궁금하고, 출입국관리사무소 방문 예약은 미리 해야 하는지도 알고 싶습니다.',
...
export const commentDummyData: CommentDummy[] = [
  {
    id: 101,
    postId: 1,
    parentId: null,
    authorName: '마리아 곤잘레스',
    authorNationality: 'Philippines',
    authorProfileImgUrl: 'https://randomuser.me/api/portraits/women/45.jpg',
    createdAt: new Date('2025-01-05T11:10:00Z'),
    content:
      '저는 작년에 갱신했는데 회사에서 재직증명서와 근로계약서를 준비해줬습니다. 예약은 최소 2주 전에 하시는 걸 추천드립니다.',
    numOfLike: 5,
    isLikedByMe: false,
  },
  {
    ...
    parentId: 101,
    authorName: '응우옌 반 민',
    authorNationality: 'Vietnam',
    authorProfileImgUrl: 'https://randomuser.me/api/portraits/men/32.jpg',
    createdAt: new Date('2025-01-05T12:05:00Z'),
    content: '답변 감사합니다! 혹시 온라인 예약 링크도 공유해주실 수 있을까요?',
    numOfLike: 2,
    isLikedByMe: true,
  },
  {
    ...
    parentId: null,
    authorName: '알리 하산',
    authorNationality: 'Uzbekistan',
    authorProfileImgUrl: 'https://randomuser.me/api/portraits/men/12.jpg',
    createdAt: new Date('2025-01-05T13:40:00Z'),
    content:
      '접수증을 받으면 체류 만료일이 지나도 합법 체류 가능합니다. 저도 그렇게 처리했습니다.',
    numOfLike: 7,
    isLikedByMe: false,
  },
];
